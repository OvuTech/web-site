          ...
          <nav className="flex flex-wrap justify-center items-center gap-4 md:gap-6 lg:gap-8 mb-8 md:mb-10">
            {footerLinks.map((link, index) => (
              <React.Fragment key={link.name}>
                <Link 
                  href={link.href}
                  className="font-manrope font-normal text-[14px] text-white hover:text-[#3B729C] transition-colors"
                >
                  {link.name}
                </Link>
          ...
          <div className="flex justify-center items-center gap-6 md:gap-8 mb-12 md:mb-16">
            {socialLinks.map((social) => (
              <Link 
                key={social.name}
                href={social.href}
                className="text-white hover:text-[#3B729C] transition-colors"
                aria-label={social.name}
              >
                <div className="w-6 h-6 md:w-7 md:h-7">
                  {/* Placeholder for social icons - you can replace with actual icons */}
