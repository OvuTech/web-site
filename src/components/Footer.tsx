    ...
    <footer ref={ref} className="bg-[#1A1A1A] text-white">
      ...
      <div className="w-full px-4 md:px-8 py-12 md:py-16">
        <div className="max-w-[1728px] mx-auto">
          ...
          {/* Navigation Links */}
          <motion.nav
            className="flex flex-wrap justify-center items-center gap-2 md:gap-3 mb-6 md:mb-8"
          ...
          >
            {footerLinks.map((link, index) => (
              <React.Fragment key={link.name}>
                <Link 
                  href={link.href}
                  className="font-manrope font-normal text-[14px] md:text-[16px] text-white hover:text-[#3B729C] transition-colors"
          ...
          >
            <p 
              className="font-manrope font-normal text-[14px] md:text-[16px] text-white text-center"
              style={{ fontFamily: 'Arial, sans-serif' }}
            >
          ...
          {/* Social Media Icons */}
          <motion.div
            className="flex justify-center items-center gap-4 md:gap-6 mb-12 md:mb-16"
            initial={{ opacity: 0, y: 20 }}
            animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
          ...
          >
            {socialLinks.map((social) => (
              <Link 
                key={social.name}
                href={social.href}
                className="bg-black p-2 rounded hover:opacity-80 transition-opacity"
      ...
      {/* Copyright Section */}
      <motion.div
        className="w-full bg-[#065888] py-2"
        initial={{ opacity: 0 }}
